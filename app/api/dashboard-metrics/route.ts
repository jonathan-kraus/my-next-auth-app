...
export async function GET() {
    ...
    try {
        ...
        await log.info("Metrics successfully calculated.", TEST_USER_ID, requestId, { totalLogs, uniqueUserCount });
        ...
        await log.error("Dashboard metrics calculation failed.", TEST_USER_ID, requestId, { error: errorMessage });
        
        return NextResponse.json({ success: false, message: 'Failed to fetch metrics.', error: errorMessage }, { status: 500 });
    }
}